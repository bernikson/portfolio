		...
		<div>
			<div id="bgWrapper">
				<nav className={scrollNav ? "scrollNav" : undefined}>
					<h1>Berniko</h1>
					<ul
						className={responsiveNav ? "responsive-nav" : undefined}
					>
						<li>
							<Link
								activeClass="active"
			...
			<section id="about">
				...
				<article>
					<aside>
						<h4>Greetings!</h4>
						<p>
							I am full stack web developer, as well as web
							designer with 3-4 years of experience in this field.
							I was born in Georgia, Tbilisi.
						</p>
						<p>
							I am willing to advance in my career and become
			...
			<section id="projects">
				...
				<article>
					<div
						onClick={() =>
							window.open(
								"https://berniko-store.herokuapp.com",
								"_blank"
							)
						}
					>
						...
						<aside>
							...
							<h5>
								Description:
								<span>
									Ecommerce type website where you can sell
									virtual products. Accepts crypto payment and
					...
					<div
						onClick={() =>
							window.open(
								"https://skillsense-5df5e.web.app/",
								"_blank"
							)
						}
					>
				...
				<article>
					<div>
						...
						<aside>
							...
							<h4>
								I have been web developer for 3-4 years,
								currently working as of full stack web developer
							</h4>
						</aside>
					</div>
					<div>
						<aside>
							<h3>Web design</h3>
							<h4>
								I have been designing templates for few months.
								Technologies I use for design are Figma and
								adobe Xd
							</h4>
						</aside>
